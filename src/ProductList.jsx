    ...
    const plantsArray = [
        {
            ...
            plants: [
                ...
                { name: "Rubber Plant", image: "https://cdn.pixabay.com/photo/2020/02/15/11/49/flower-4850729_1280.jpg", description: "Easy to grow and removes toxins from the air.", cost: "$17" },
                { name: "Aloe Vera", image: "https://cdn.pixabay.com/photo/2018/04/02/07/42/leaf-3283175_1280.jpg", description: "Purifies air and has healing properties for skin.", cost: "$14" }
            ]
        },
        {
            ...
            plants: [
                ...
                { name: "Lemon Balm", image: "https://cdn.pixabay.com/photo/2019/09/16/07/41/balm-4480134_1280.jpg", description: "Citrusy scent, relieves stress and anxiety.", cost: "$14" },
